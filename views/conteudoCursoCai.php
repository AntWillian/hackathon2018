<?php
    ...
    if(isset($_GET['btnSalvar'])){
        ...
        if(!empty($_FILES['flImagem']['name'])){
            $imagem_file = true;
            $diretorio_completo=salvarFoto($_FILES['flImagem'], 'imagemCai');
        ...
        if($_GET['btnSalvar'] == 'Salvar'){
            $sql = "INSERT INTO tbl_curso_cai (nome, descricao, area, duracao, preRequisitos, link, processoSeletivo, dtInicio, dtFim, horaInicio, horaFim, imagem) ";
            ...
            if($imagem_file == true && $MovUpload == true){
                ...
                WHERE idCursoCai = ".$_SESSION['idSessao'];
            } else {
                $sql = "UPDATE tbl_curso_cai SET
                nome = '".$nome."',
                descricao = '".$descricao."',
    ...
    if(isset($_GET['modo'])){
        ...
        if($modo == 'excluir'){
            $id = $_GET['id'];
            $sql = "DELETE FROM tbl_curso_cai WHERE idCursoCai =".$id;
            mysql_query($sql);
        } else if($modo == 'consultar'){
            $id = $_GET['id'];
            //echo $id;
            $sql = "SELECT * FROM tbl_curso_cai WHERE idCursoCai =".$id;
...
//                echo $dataFim;
            ...
            if($status == 1){
                $sql = "UPDATE tbl_curso_cai SET processoSeletivo = 0 WHERE idCursoCai =".$id;
            } else {
                $sql = "UPDATE tbl_curso_cai SET processoSeletivo = 1 WHERE idCursoCai =".$id;
            }
            mysql_query($sql);
        }
    }
...
<div class="padrao">
  <div class="titulo">
    <h1>Administrção de Cursos > CAI</h1>
  </div>
  ...
  <div class="contents">
    ...
    <div class="content_tabela">
      ...
      <div class="content_registros">
          <?php
            $sql = "SELECT * FROM tbl_curso_cai order by idCursoCai desc";
            $cont=0;
            $result = mysql_query($sql);
            while($cursos = mysql_fetch_array($result)){
              ...
              <div class="linha_registros <?php echo $cor ?>">
                ...
                <div class="caixas_registros">
                <a href="#" class="cai" onclick=cai(<?php echo($cursos['idCursoCai'])?>)>
                        <img src="../imagems/visualizar.png">
                    </a>
                    |
                    <a href="?pag=cai&modo=consultar&id=<?php echo($cursos['idCursoCai'])?>">
                        <img src="../imagems/editar.png">
                    </a>
                    |
                    <a href="?pag=cai&modo=excluir&id=<?php echo($cursos['idCursoCai'])?>">
                        <img src="../imagems/deletar.png">
                    </a>
                    |
                    <a href="?pag=cai&modo=status&id=<?php echo($cursos['idCursoCai'])?>&status=<?php echo($cursos['processoSeletivo'])?>">
  ...
  <div class="contents">
    ...
    <div class="content_form">
        <form name="frmCadastroCursoCai" method="post" action="?pag=cai&btnSalvar=<?php echo($botao);?>" enctype="multipart/form-data">
            ...
            <div class="linhas_campos">
                <div class="campos" id="campo_nomeCursoCai">
                ...
                <div class="campos" id="campo_descricaoCai">
                    <div class="titulos_campos">
                        Descrição do Curso
                    </div>
            ...
            <div class="linhas_campos">
                ...
                <div class="campos" id="campo_duracaoCai">
                    <div class="titulos_campos">
                        Duração (em Horas)
                    </div>
                    <input type="text" name="txtDuracao" id="txtDuracao" placeholder="Duração do curso..." class="inputs_menores" value="<?php echo($duracao);?>" required maxlength="45">
                </div>
                <div class="campos" id="campo_preRequisitosCai">
                    <div class="titulos_campos">
                        Pré Requisitos
                    </div>
            ...
            <div class="linhas_campos">
                <div class="campos" id="campo_linkCai">
                    <div class="titulos_campos">
                        Link da Página
                    </div>
                    <input type="url" name="txtLink" id="txtLink" placeholder="Ex: http://www.senai.com.br/processoseletivo" value="<?php echo($link);?>" required maxlength="255">
                </div>
            </div>
            <div class="linhas_campos">
                <div class="campos_horas">
                    ...
                    <input type="text" name="txtHoraInicio" placeholder="Ex: 14h" id="txtHoraInicio" class="inputs_menores" value="<?php echo($horaInicio);?>" required maxlength="3">
                </div>
                ...
                <div class="campos_horas">
                    ...
                    <input type="text" name="txtHoraFim" placeholder="Ex: 14h" id="txtHoraFim" class="inputs_menores" value="<?php echo($horaFim);?>" required maxlength="3">
                </div>
                <div class="campos_datas">
                    <div class="titulos_campos">
                        Data de Fim
